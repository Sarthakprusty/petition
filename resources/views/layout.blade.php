                        ...
                        <div id="collapseForm" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#side-menue">
                            <div class="accordion-body">
                                <div class="list-group list-group-flush">
                                    ...
                                    <div class="list-group-item">
                                        <a href="{{route('applications.create')}}">Search</a>
                                    </div>
                                    <div class="list-group-item">
                                        <a href="{{route('applications.create')}}">Modify Form</a>
                                    </div>
                                    <div class="list-group-item">
                                        <a href="{{route('applications.create')}}">Status</a>
                                    </div>
                                    <div class="list-group-item">
                                        <a href="{{route('applications.create')}}">Acknowledge Modify</a>
                                    </div>
                                    <div class="list-group-item">
